...
import com.pysarivka.WeekEnds.dao.UserRepository;
import com.pysarivka.WeekEnds.domain.User;
import com.pysarivka.WeekEnds.domain.UserRole;
import com.pysarivka.WeekEnds.service.UserService;
...
public class UserServiceImpl implements UserService {
	...
	public User updateUser(User user) {
	    ...
	    logger.info("Updated user успішно збережено в БД: " + updatedUser);	    
	    return updatedUser;
	}
